...
public class EntityFactory {
    ...
    public static List<Entity> createEntites (Activity inst){
        activityInst = inst ;
        List entities = new ArrayList<Entity>();
        Entity entity  ;
        entity= new Entity(null, "elephant","elephant",getBitMap("elephant"),(float)0,(float)0, (float)0 , (float)0);

        entities.add(entity);

        entity= new Entity(null , "giraffe","giraffe", getBitMap("giraffe"), (float) 300,(float) 300 , (float)0 , (float)0);
        entities.add(entity);
